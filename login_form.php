    ...
    <section id="login" class="contents">
      ...
      <div id="social_login_btn">
        ...
        <a href=<?php echo SocialLogin::socialLoginUrl("google")
                ?>><img src="./images/login/google_btn.png" width="200"></a>
        <a href=<?php echo SocialLogin::socialLoginUrl("kakao")
                ?>><img src="./images/login/kakao_login_medium_narrow.png" width="200"></a>
        <a href=<?php echo SocialLogin::socialLoginUrl("naver")
                ?>><img src="./images/login/naver_btn.png" width="180"></a>
