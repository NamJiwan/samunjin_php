...
class TokenModel
{
    ...
    public function toString()
    {
        ...
        return 'acceccToken :' . $this->accessToken . 'refreshToken :' . $this->refreshToken . '';
    }
}
...
class ProfileModel
{
    public $nickname;
    public $email;
    //API code [php 파일 다 저한테 주심됩니다] / KAKAO API 주소값 = www.samunjin.site  / samunjin.site  || https:// 
    //html Script 파일을 알아가지고 테스트 진행하심됩니다.  js / html 홈페이지 테스트 하시고 === login 페이지에 직접 버튼을 그대~~로 넣어서 주심 됩니다 
    public $uid;
...
//각 플랫폼에 따른 소셜로그인 restapi 실행
//결과값 json 데이터 (acce, refresh)를 넣어
//
