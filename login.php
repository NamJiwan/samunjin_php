...
<body>
    ...
    <section id="login" class="contents">
      ...
      <form action="">
        <fieldset>
          <div class="bigBox">
            <div class="inputBox">
              <input class="textBox" type="text" placeholder="아이디" />
              <input class="textBox" type="text" placeholder="비밀번호" />
            </div>
            <button>로그인</button>
          </div>
          <!-- 카카오로그인 -->
  ...
  <script type="text/javascript">
    ...
    var naver_id_login = new naver_id_login("_eKCYA0sQZDO7VLHX24d", "https://elaborate-nasturtium-7ef512.netlify.app/naver_callback.html");
